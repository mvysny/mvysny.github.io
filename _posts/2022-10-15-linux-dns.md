...
It should print the DNS servers for every network interface. Make sure you can ping
...
But you can view its logs and/or status, maybe they will reveal something of interest:
