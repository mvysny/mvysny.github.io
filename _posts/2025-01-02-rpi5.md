...
and Ubuntu 25.10 works really well too.
...
The Micro-HDMI ports are a disastrous choice - they look extremely fragile,
...
## Ubuntu 25.10 works really well

Ubuntu 25.10 arm64 is easy to flash and install using the RPI Imager app.
The OS is incredibly snappy and works well in Wayland mode. 3d acceleration works;
Firefox works correctly and the webgl aquarium shows 40fps for 1000 fish.

## (old stuff): Ubuntu 24.10 is a disaster
