---
layout: post
title: Terrible experience with FedEx
---

The delivery guy dropped first package to a different
place; second package stuck in local depot with no estimate;
chat useless.
...
As a bonus, you don't have to sit at home all day, waiting for the courier to show up.
...
FedEx web site allows you to send feedback, apparently to `/dev/null`
