...
roads, the bureaucracy, the winter salt eating your car, the general assumption
that a rule exists to be worked around. So it genuinely surprised me to find one
thing where Slovakia quietly wins: **you never have to read a traffic sign from
behind.** In the Nordics you do. Officially.
...
right-hand-regulated junctions than at yield-regulated ones** — on the order of
...
| Feature | Finland | Sweden | Norway | Slovakia |
|---|---|---|---|---|
| Default at unsigned junction | Priority to the right | *högerregeln* | *høyreregelen* | *prednosť sprava* |
| Priority road sign | *Etuajo-oikeutettu tie* (yellow diamond) | *Huvudled* | *Forkjørsvei* (sign 206) | *Hlavná cesta* |
| Priority persists across junctions? | Yes, until end sign | Yes, until *upphör* | Yes, until *slutt* | **No — re-posted each junction** |
| Ever need to "read from behind"? | Yes | Yes | Yes | **No** |

So: Slovakia gets a hundred things wrong for every one Finland gets right. But
this one it got **better** — and I don't mean "a defensible alternative," I mean
*genuinely better road design*.
